...
# Output Files
BEST_MODEL_PATH = os.path.join(MODEL_DIR, 'best_bert_lstm_crf_model.pth')
HISTORY_CSV_PATH = os.path.join(RESULT_DIR, 'bert_lstm_crf_training_history.csv')
...
# --- 3. Model Architecture (BERT + BiLSTM + CRF) ---
...
# Initialize Model
model = BertLstmCrfForNer(num_labels=len(LABELS_LIST)).to(DEVICE)
...
def train():
    ...
    plot_training_history(df, "BERT-LSTM-CRF")
    return df
